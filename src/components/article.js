...
function ArticleItem(articol,index){
    ...
    return (
        ...
        <div key={index} className='card' id={articol.id}>
        <img src={link_poza} className='card-img-top img-fluid' style={{"object-fit": "cover","width":"100%", "height":"300px"}}></img>
        <div className='card-body'>
            ...
            <a href={articol.link} className="btn btn-primary">Vezi anuntul</a>
        </div>
        </div>
        </div>
    )
